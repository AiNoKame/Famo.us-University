define(function(require, exports, module) {
  ...
  AppView.DEFAULT_OPTIONS.slideWith = 0.8 * AppView.DEFAULT_OPTIONS.cameraWidth;
  AppView.DEFAULT_OPTIONS.slideHeight = AppView.DEFAULT_OPTIONS.slideWith + 40;
  ...
  function _createSlideshow() {
    var slideshowView = new SlideshowView({
      size: [this.options.slideWith, this.options.slideHeight],
